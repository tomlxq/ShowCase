...
import com.photograph.dao.BaseModuleMapper;
...
public class BaseModuleServiceImpl implements BaseModuleService {
	@Autowired
	private BaseModuleMapper baseModulesMapper;
	@Autowired
	...
	public Tree selectAllModules(Criteria example) {
		...
		List<BaseModule> list = this.baseModulesMapper.selectByExample(example);
