...
public class ServerControllerTest {
    ...
    public void test1() throws Exception {
        ...
        mockMvc.perform(get("/user/{id}", 1)) //执行请求
                ...
                .andExpect(model().attribute("user", hasProperty("name", equalTo("tom")))) //验证存储模型数据
   ...
   //测试普通控制器，但是URL错误，即404
    ...
    public void test4() throws Exception {
        //验证请求参数绑定
        mockMvc.perform(post("/user").param("name", "tom")) //执行传递参数的POST请求(也可以post("/user?name=zhang"))
   ...
   //文件上传
    ...
    public void test7() throws Exception {
        //JSON请求/响应
        String requestBody = "{\"id\":1, \"name\":\"tom\"}";
        ...
        String errorBody = "{id:1, name:tom}";
    ...
    public void test8() throws Exception {
        //XML请求/响应
        String requestBody = "<user><id>1</id><name>tom</name></user>";
        mockMvc.perform(post("/user")
        ...
        String errorBody = "<user><id>1</id><name>tom</name>";
        MvcResult result = mockMvc.perform(post("/user")
