...
public class DataFormatTestController {
     //http://localhost:8080/springmvc-chapter7/format1?totalCount=100000&discount=0.51&sumMoney=100000.128&phoneNumber=010-12345678
    @RequestMapping(value = "/format1")
    public String test1(@ModelAttribute("model") FormatterModel formatModel) {
		return "format/success";
	}

	//http://localhost:8080/springmvc-chapter7/format2?phoneNumber=010-12345678&date=2012-05-01
