package com.photograph.common.utils;
...
public class PropertiesHolder implements InitializingBean {
	...
	public static PropertiesHelper properties = null;

	public void setProperties(Properties properies) {
		logger.debug("properies is null or not {}",properies);if(PropertiesHolder.properties==null){
		Assert.isNull(PropertiesHolder.properties, "PropertiesHolder already hold properties");

		PropertiesHolder.properties = new PropertiesHelper(properies);}
	}
