...
public class TomProxy {
    ...
    private static String generateSrc(Class<?> intfs) {
        ...
        stringBuffer.append("package com.example.demo.pattern.proxy.customer;" + SEP +
                "import com.example.demo.pattern.proxy.jdk.Person;" + SEP +
                "import com.example.demo.pattern.proxy.customer.TomInvocationHandler;" + SEP +
